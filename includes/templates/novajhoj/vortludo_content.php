<?php
    ...
    echo headerPhoto('novajhoj_vortludo_betatesto', 'vortludo_banner.png');
?>

<p class="p"><i>22-a de junio 2019, DEJO</i></p>

<p class="p">Dana Esperantista Junulara Organizo, subtenante la danan videoludstudion <a href="http://krifle.com/">Krifle Games</a>, nun fiere anoncas, ke ni serĉas betatestantojn por nova poŝtelefona ludo en Esperanto bazita sur la bone konata ludo Skrablo.</p>

<p class="p"><i>Anonco sekvas:</i></p>
...
<p class="p">Legu nian retejon por pli da informoj: <a href="https://vortludo.com/">VORTLUDO.COM</a></p>

<p class="p">Aliĝu kiel betatestanto <a href="https://forms.gle/MUwHZzKPVvRF3Ww28">ĉi tie</a>, kaj Krifle Games rekte kontaktos vin per retpoŝto.</p>

<p class="p">Postuloj pri betatestantoj:</p>

<ul class="ul">
     <li>Poŝtelefonoj: Android aŭ iOS</li>
     <li>Nivelo de Esperanto: B1 – C2</li>
     <li>Aĝo: 17+ jarojn</li>
</ul>

<p class="p">DEJO dankas vin pro via helpo.</p>
